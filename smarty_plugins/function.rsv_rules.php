...
function smarty_function_rsv_rules($params, &$smarty)
{
  ...
  {
    $lines[] = "<optgroup label=\"{$LANG["custom_fields"]["phrase_standard_rsv_validation"]}\">";
  ...
  $lines[] = "<optgroup label=\"{$LANG["custom_fields"]["phrase_custom_validation"]}\">";
  $lines[] = "<option value=\"function\"" . (($default == "function") ? " selected" : "") . ">{$LANG["custom_fields"]["word_function"]}</option>";
  $lines[] = "</optgroup>";
  $lines[] = "</select>";
